...
ActiveRecord::Schema[8.0].define(version: 2025_12_27_215651) do
  ...
  create_table "areas", force: :cascade do |t|
    ...
    t.index ["display_order"], name: "index_areas_on_display_order"
    t.index ["is_active"], name: "index_areas_on_is_active"
  end
